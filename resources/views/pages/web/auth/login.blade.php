...
<div class="form-container">
                <form action="{{ route('web.auth.login') }}" method="post" >
                  ...
                  <p>Belum punya akun ? || <a  style="color : #3498db" href="{{ route('web.auth.register') }} " > Registrasi </a></p>
                  <p>Masuk sebagai Admin? || <a style="color : #3498db" href="{{ url('admin/auth') }}" > Login </a></p>
                </form>
              </div>
      </body>
</html>